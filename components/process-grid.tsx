...
export function ProcessGrid() {
    return (
        ...
        >
            ...
            >
              <h3 className="text-2xl font-bold uppercase tracking-tighter text-secondary-foreground md:text-3xl lg:text-4xl">
                {s.title}
              </h3>
              <p className="mt-6 text-lg font-medium leading-tight tracking-tight text-secondary-foreground/80 md:text-xl">
                {s.body}
              </p>
            </article>
                    ))}
